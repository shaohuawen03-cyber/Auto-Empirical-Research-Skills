# A proteome-supported screen of periodontitis-specific sORF peptides yields twelve metal-binding, barrier-passing candidates that dock to the pathogenic peripheral anionic site of acetylcholinesterase

**Article type.** Computational research article (screening + structure-based follow-up).  
**Version.** v0.4 (2026-08-12). Supersedes v0.3; the bilingual draft v0.2 remains an archive.  
**What is new in v0.4.** (i) The twelve main-candidate sequences are now printed (author-supplied); (ii) PAS-focused AutoDock Vina docking of all twelve candidates against human AChE (PDB 4EY6) is reported as a new Results section (3.7) with Methods 2.10–2.11; (iii) the Introduction is expanded to SCI length with the exogenous toxic-peptide literature frame (tau26–44/Cu(II) paradigm, Di Natale 2018; Perini 2019; Lei 2021) and verified citations; (iv) the author’s forward protocol (AlphaFold3, target panel, metal/QM, FlexPepDock, MD debugging, wet-assay cascade) is integrated as Discussion 4.5.  
**Evidence spine.** Author files `材料与方法及结果_机制研究版` (screening) and the author’s PAS docking note with Table 3-5 (this version).  
**Target venues (realistic).** *Briefings in Bioinformatics*; *Computational and Structural Biotechnology Journal*; *Journal of Alzheimer’s Disease*; *Scientific Reports* (computational / microbiome section).  
...
Periodontitis is epidemiologically associated with Alzheimer’s disease (AD), yet most molecular accounts stop at intact *Porphyromonas gingivalis* cells, gingipain proteases, or outer-membrane vesicles. Short peptides encoded by oral small open reading frames (sORFs) are a larger, poorly counted cargo. We re-analysed a public oral metagenome collection (BioProject PRJNA678453; assembly set PRJEB65451) comprising 296 high-quality metagenome-assembled genomes from 24 healthy and 26 periodontitis donors. After length filtering (4–50 amino acids), group-specific sORF libraries contained 11,269,961 and 11,721,988 sequences. Exact identity matching to HOMD-linked oral proteomes left 31,510 and 33,786 non-redundant peptides (passage 0.2796% and 0.2882%). Peptides were scored with UniDL4BioPep at predicted probability ≥ 0.8, with short (5–30 aa) and long (31–50 aa) branches kept separate. Periodontitis contributed more blood–brain-barrier (BBB) calls in both branches (short 3,446 vs 3,359; long 72 vs 40). The 3,518 periodontitis-oriented BBB peptides were passed to NTxPred2, mebipred and AnOxPePred; NTxPred2 called 923 of 3,299 scored sequences neurotoxic, mebipred marked 111 Cu/Fe/Zn binders, and AnOxPePred retained 15 peptides with chelator score ≥ 0.25. Requiring a scavenger score < 0.50 left **12 main candidates** (< 0.45 left 8). All twelve are 7–9-mers; eleven of twelve carry histidine and six carry cysteine, matching the His/Cys anchoring chemistry seen in metal-binding neurotoxic peptide paradigms such as tau26–44. In a new structure-based stage, PAS-focused docking with AutoDock Vina 1.2.5 against human acetylcholinesterase (PDB 4EY6, 40 × 40 × 40 Å³ box centred on the peripheral anionic site) placed every peptide fully inside the box, with scores of −8.25 to −9.60 kcal/mol and gorge-spanning poses contacting PAS residues (Tyr72, Asp74, Tyr124, Trp286, Tyr341) and gorge aromatics (Trp86, Phe295, Tyr337, Phe338); several side chains reach the catalytic Ser203/His447 region. These results are a prioritisation, not proof: docking scores rank poses, they are not binding constants; a 100-ns molecular dynamics check was attempted but is excluded from this stage after pressure instabilities. Only wet assays—metal binding, Cu/Fe-dependent ROS, lipid peroxidation, cholinesterase activity, Aβ aggregation and neuronal viability—can promote any candidate to a mechanistic claim.

**Keywords.** periodontitis; sORF; metaproteome; UniDL4BioPep; blood–brain barrier; metal binding; acetylcholinesterase; peripheral anionic site; molecular docking; Alzheimer’s disease

---

## 中文摘要

牙周炎与阿尔茨海默病（AD）有流行病学关联，但分子叙述多停在完整牙龈卟啉单胞菌、牙龈蛋白酶或外膜囊泡。口腔小开放阅读框（sORF）编码的短肽是更大、却很少被清点的货物。我们再分析公开口腔宏基因组（PRJNA678453 / PRJEB65451）：296 个高质量组装基因组，24 名健康对照与 26 名牙周炎患者。长度过滤（4–50 氨基酸）后，组特异 sORF 库分别为 11,269,961 与 11,721,988 条；与 HOMD 相关口腔蛋白质组精确匹配后，非冗余肽 31,510 与 33,786 条（通过率 0.2796% 与 0.2882%）。UniDL4BioPep 以预测概率 ≥ 0.8 打分，短肽与长肽分开统计：牙周炎组血脑屏障（BBB）阳性在两支都更多（短肽 3,446 对 3,359；长肽 72 对 40）。3,518 条 BBB 肽进入 NTxPred2、mebipred 与 AnOxPePred：3,299 条打分序列中 923 条判为神经毒性，111 条为 Cu/Fe/Zn 结合阳性，螯合分 ≥ 0.25 者 15 条；再要求自由基清除分 < 0.50，得 **主候选 12 条**（< 0.45 得 8 条）。十二条均为 7–9 肽：11 条含组氨酸、6 条含半胱氨酸，与 tau26–44 等金属结合神经毒肽范例中的 His/Cys 锚定化学一致。新增结构阶段中，AutoDock Vina 1.2.5 对人乙酰胆碱酯酶（PDB 4EY6，40 × 40 × 40 Å³ 盒子聚焦外周阴离子位点 PAS）对接显示：所有多肽完整进入盒子，打分 −8.25 至 −9.60 kcal/mol，呈跨越 PAS 与催化峡部的结合模式，接触 PAS 残基（Tyr72、Asp74、Tyr124、Trp286、Tyr341）与峡部芳香残基（Trp86、Phe295、Tyr337、Phe338），部分侧链延伸至催化中心 Ser203/His447 附近。上述结果是优先级排序，不是证明：对接打分是构象排序工具，不是结合常数；100 ns 分子动力学核查已尝试，因压力不稳定未纳入本阶段。只有金属结合、Cu/Fe 依赖 ROS、脂质过氧化、胆碱酯酶活性、Aβ 聚集与神经元存活等湿实验，才能把任何候选升格为机制结论。

**关键词.** 牙周炎；sORF；宏蛋白质组；UniDL4BioPep；血脑屏障；金属结合；乙酰胆碱酯酶；外周阴离子位点；分子对接；阿尔茨海默病
...
The gap in that account is the carrier problem. Metal dyshomeostasis in AD is usually discussed as a failure of host transporters and storage proteins. A periodontitis-linked account additionally needs a molecule that can leave the mouth, survive serum, cross or bypass the blood–brain barrier, and present redox-active coordination chemistry inside brain parenchyma. Short, His/Cys-rich peptides are among the few molecular formats that plausibly do all of those things, which motivates screening the oral metaproteome for exactly that chemistry.
...
This paper has two stages. Stage one (Sections 2.2–2.9, 3.1–3.6) asks the countable question from our earlier version: after a periodontitis-specific sORF library is restricted to peptides observed in oral proteomes, how many survive a BBB filter, a neurotoxicity filter, a Cu/Fe/Zn filter, and a chelator-high / scavenger-low rule? The answer is twelve peptides (eight at a stricter scavenger cut). Stage two (Sections 2.10–2.11, 3.7) is new: the twelve sequences—now supplied by the author—are taken to the structure level by PAS-focused molecular docking against human AChE (PDB 4EY6 [8]), the PAS being chosen because it is both the Aβ-accelerating site of AChE [4–6] and the neighbourhood of the published Aβ residence patch at residues 344–361 [9].

Three boundaries are stated up front, in the same tense as the source drafts. (i) The MAG collection is a **community** oral metagenome [33], not a *P. gingivalis*-only peptidome; assignment of the twelve sequences to a single species is not claimed. (ii) Docking scores are ranking heuristics with known scoring-function bias; they are used here to compare twelve candidates against one binding site, not to predict *K*<sub>d</sub> values. (iii) Molecular dynamics, QM/MM and all wet assays remain future work (Sections 2.11 and 4.5); the stopping rule stands—only a peptide that raises ROS or lipid peroxidation **in the presence of metal** and damages neurons earns the phrase “metal-linked pro-oxidant neurotoxicity.”
...
The source draft lists AChE, butyrylcholinesterase, Aβ42, tau, ApoE4, ferritin and transferrin as structural targets, with AChE attention on the CAS, the PAS and the AChE–Aβ interface. In v0.3 none of them had been docked. In the present version, PAS-focused docking of the twelve main candidates against human AChE (PDB 4EY6) has been completed and is reported in Section 3.7. The remaining targets, full metal-ion coordination modelling, production molecular dynamics and QM/MM/DFT are still future work (Section 4.5). GSE42872 (vemurafenib in BRAF-V600E A375 melanoma [34]) and a translation of a 1 μs AChE–Aβ trajectory [9] are archived beside this manuscript and are not inputs to the screening tables.
...
![Figure 5. PAS-focused docking scores](figures/fig5_docking_scores.png)

**Figure 5.** Vina docking scores of the twelve main candidates against the PAS-centred 4EY6 box. Error bars are ± SD; the dashed line marks −8.0 kcal/mol.
...
The operational product of the screening stage is unchanged from v0.3: oral proteomes discard more than 99.7% of translated sORFs, and a BBB-first, metal-second, scavenger-low stack reduces 33,786 periodontitis-supported peptides to 12 (8 at the stricter cut). That is a prioritisation result. What v0.4 adds is the structure-level readout that makes the list actionable: every one of the twelve candidates can physically occupy the PAS–gorge interface of human AChE with plausible chemistry and sub-−8 kcal/mol Vina scores. A twelve-peptide list with poses is a project; a twelve-peptide list without poses was an inventory.
...
**Data availability.** PRJNA678453, PRJEB65451, PXD003151, PXD004319, PXD026727 and HOMD are public; PDB 4EY6 is public [8]. The twelve candidate sequences are in Table 5. Author screening tables are in `projects/1yzy-pg-ad-mechanism/source-docs/`.

**Code availability.** Figure scripts are in `projects/1yzy-pg-ad-mechanism/scripts/`. UniDL4BioPep is described by Du et al. [32]; AutoDock Vina by Trott & Olson [35] and Eberhardt et al. [36].
...
**AI use.** An AI assistant assembled this manuscript from the author’s methods/results drafts under the AERS / nature-skills workflow and verified the new citations against PubMed/PDB records. The author remains responsible for every number and claim.

---

## Figure legends

**Figure 1.** Screening design. Two hundred and ninety-six MAGs from 24 healthy and 26 periodontitis donors were translated to 4–50 aa sORFs, collapsed by exact oral-proteome identity, scored with UniDL4BioPep, filtered for BBB, neurotoxicity, metal binding and chelator/scavenger scores, and—new in v0.4—carried to PAS-focused docking against 4EY6.
...
**Figure 4.** Length mix of 3,518 BBB-positive peptides. Most short BBB peptides are 8–15 aa; the twelve docking candidates (7–9 aa) sit inside that mode.

**Figure 5.** PAS-focused Vina docking scores of the twelve main candidates against human AChE (PDB 4EY6, 40 × 40 × 40 Å³ box). Bars: mean scores; error bars: ± SD; top-ranked peptide (FLLHTTR) in blue, remaining candidates in vermillion.
...
22. Frontiers in Aging Neuroscience. Different stages of Alzheimer’s disease with periodontitis: clinical features and potential mechanisms involving gingipains. 2026. doi:10.3389/fnagi.2026.1737524. Confirm author line on the publisher PDF before submission.  
23. Kanagasingam S, Chukkapalli SS, Welbury R, Singhrao SK. *Porphyromonas gingivalis* is a strong risk factor for Alzheimer's disease. J Alzheimers Dis Rep. 2020;4(1):501-511. doi:10.3233/ADR-200250  
...
31. van Heesch S, Wit F, Botter J, Brakel J, van den Hoek S, Mulder S, et al. The translational landscape of the human heart. Cell. 2019;178(1):236-251.e24. doi:10.1016/j.cell.2019.05.010  
...
42. Abramson J, Adler J, Dunger J, Evans R, Green T, Pritzel A, et al. Accurate structure prediction of biomolecular interactions with AlphaFold 3. Nature. 2024;630(8016):493-500. doi:10.1038/s41586-024-07487-w  
...
> **Citation corrections applied in v0.4 (verified against PubMed/PDB, 2026-08-12).**
> The author’s literature table cited Di Natale et al. as “Inorganica Chimica Acta 2018, DOI 10.1016/j.ica.2017.12.012, PMID 29289679” and Perini et al. as “Sci Rep 2019, DOI 10.1038/s41598-019-48745-0”. Both were verified and corrected: the Di Natale paper is Inorg Chim Acta 2018;472:82–92, DOI 10.1016/j.ica.2017.09.061 (PMID 29289679 resolves to an unrelated motor-control article and was discarded); the Perini paper is Int J Biol Macromol 2019;141:278–289, DOI 10.1016/j.ijbiomac.2019.08.220, PMID 31470053 (not Scientific Reports). Lei, Ayton & Bush (J Biol Chem 2021;296:100105, DOI 10.1074/jbc.REV120.008207, PMID 33219130) was verified as given. PDB 4EY6 is cited through its primary reference, Cheung et al. J Med Chem 2012 (PMID 23035744).
